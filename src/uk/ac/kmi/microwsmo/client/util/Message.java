...
public final class Message {
	...
	public static void show(String command, String param) {
		if( command.equals(AJAX) ) {
			...
			MessageBox.alert(title + "Semantic Annotation warning", "The highlighted keyword doesn't correspond with the chosen entity", null);
			...
			MessageBox.alert(title + "Annotation warning", "You should select the text before annotate", null);
		} else if( command.equals(WATSON_SELECTION) ) {
			MessageBox.alert(title + "Watson warning", "You should highlight the term into the text before query Watson", null);
			...
			MessageBox.info(title + "Watson info", "Watson returned not search results for this keyword", null);
		}
	}
